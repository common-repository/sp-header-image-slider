...
A quick, easy way to add an Header image slider with captions OR image slider with captions inside wordpress page. Also work with Gutenberg shortcode block.

== Description ==

> Important Recommendations : For better user experience we have shifted  **WP Header image slider and carousel** plugin in our to new plugin ie [SlidersPack – All In One Image/Post Slider](https://wordpress.org/plugins/sliderspack-all-in-one-image-sliders/). It help us to maintain our all slider plugins in a single plugin package and provide you better and fast support.  
...
= 1.3.1 (25-05-2019) =
* [*] Important Recommendations : For better user experience we have shifted  "WP Header image slider and carousel" plugin in our to new plugin ie "SlidersPack – All In One Image/Post Slider". It help us to maintain our all slider plugins in a single plugin package and provide you better and fast support.
